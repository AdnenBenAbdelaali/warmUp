...
// Using jQuery, create a function, that takes the input from the text field, creates a
// list item and add it to the unordered list, then add a class to the added item alternatively
